...
use Idea\Framework\View\Front\Breadcrumbs\Exceptions\DuplicateBreadcrumbException;
use Idea\Framework\View\Front\Breadcrumbs\Exceptions\InvalidBreadcrumbException;
use Idea\Framework\View\Front\Breadcrumbs\Exceptions\UnnamedRouteException;
use Idea\Framework\View\Front\Breadcrumbs\Exceptions\ViewNotSetException;
...
class BreadcrumbsManager
{
     ...
     * @return void
     * @throws \Idea\Framework\View\Front\Breadcrumbs\Exceptions\DuplicateBreadcrumbException If the given name has already been used.
     */
     ...
     * @throws \Idea\Framework\View\Front\Breadcrumbs\Exceptions\UnnamedRouteException
     *      if no name is given and the current route doesn't have an associated name.
     ...
     * @throws \Idea\Framework\View\Front\Breadcrumbs\Exceptions\UnnamedRouteException
     *      if no name is given and the current route doesn't have an associated name.
     * @throws \Idea\Framework\View\Front\Breadcrumbs\Exceptions\ViewNotSetException
     *      if no view has been set.
     */
     ...
     * @throws \Idea\Framework\View\Front\Breadcrumbs\Exceptions\UnnamedRouteException
     *      if the current route doesn't have an associated name.
     * @throws \Idea\Framework\View\Front\Breadcrumbs\Exceptions\InvalidBreadcrumbException
     *      if the name is (or any ancestor names are) not registered.
     */
