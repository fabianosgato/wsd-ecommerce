...
trait OrdersApiResponse
{
    ...
    protected function resultSalesOrder(SalesOrder $salesOrder): array
    {
    ...
    protected function resultNone(): array
    {
