...
class SalesOrderApprovedMail extends Mailable
{
    ...
    public function build(): self
    {
        ...
        return $this->subject("{$store->store_name} :: Pedido #{$orderData['incrementCode']} Aprovado")
            ->bcc($this->getEmails())
            ->view('sales::frontend.emails.order-approved', [
                'store' => $store,
                'orderData' => $orderData
            ]);
