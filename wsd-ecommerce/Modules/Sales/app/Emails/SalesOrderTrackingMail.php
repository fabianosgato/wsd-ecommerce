...
class SalesOrderTrackingMail extends Mailable
{
    ...
    public function build(): self
    {
        ...
        return $this->subject("{$store->store_name} :: Pedido #{$orderData['incrementCode']} Acompanhe sua entrega")
            ->bcc($this->getEmails())
            ->view('sales::frontend.emails.order-tracking', [
                'store' => $store,
                'orderData' => $orderData
            ]);
