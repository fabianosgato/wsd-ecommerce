        ...
        <tr>
            <td align="center" style="padding:20px 0;">
                <table bgcolor="#FFFFFF" cellpadding="10" width="650" style="border:1px solid #E0E0E0;">
                    ...
                    <tr>
                        <td>
                            <h1 style="font-size:22px;">
                                Olá, {{ $orderData['customer']['customerName'] }}
                            </h1>

                            <p style="margin:0 0 10px 0;">
                                Seu pedido foi enviado com sucesso e já está a caminho 🚚
                            </p>

                            <p style="margin:0;">
                                Abaixo você encontra os detalhes para acompanhar a entrega.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <h3 style="font-size:15px;">Dados para rastreamento</h3>

                            <p style="margin:0 0 10px 0;">
                                Utilize as informações abaixo para acompanhar o status da sua entrega:
                            </p>

                            <ul style="margin:0; padding-left:15px;">
                                <li><strong>Transportadora:</strong> {{ $orderData['tracking']['carrier'] }}</li>
                                <li><strong>Código de rastreio:</strong> {{ $orderData['tracking']['trackingCode'] }}</li>
                                <li>
                                    <strong>Acompanhar entrega:</strong>
                                    <a href="{{ $orderData['tracking']['url'] }}" target="_blank">
                    ...
                    {{-- FOOTER --}}
                    <tr>
                        <td bgcolor="#EAEAEA" align="center" style="background-color: #EAEAEA; text-align: center">
